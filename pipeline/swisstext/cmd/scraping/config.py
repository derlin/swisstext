...
class Config(BaseConfig):
    ...
    class Options:
        ...
        def __init__(self, num_workers=1, min_proba=0.85, crawl_depth=2):
            """
            :param num_workers: maximum number of threads to use
            :param min_proba: minimum Swiss German probability to keep a sentence
                  (the probability is generated by :py:class:`swisstext.cmd.scraping.interfaces.ISgDetector`)
            :param crawl_depth: maximum depth of the crawl, inclusive.
            """
    ...
    def create_pipeline(self) -> Pipeline:
        """
        Instantiate a pipeline instance from the YAML configuration.
        """
